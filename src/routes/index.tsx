      ...
      <section class="bg-gray-50 py-16 dark:bg-[#031a16]">
        <div class="container mx-auto px-4">
          <div class="mb-12 text-center">
            ...
            <p class="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300">
              Enhance your stay with our range of services, from airport
              transfers to exciting tours and adventures
            </p>
          </div>
      ...
      <section class="bg-white py-16 dark:bg-[#041f1a]">
        <div class="container mx-auto px-4">
          <div class="mb-8 text-center">
            ...
            <p class="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300">
              Take a closer look at White Flower Guest and its cozy tropical
              surroundings.
            </p>
          </div>
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div class="p-6 text-center">
              ...
              <p class="text-gray-600 dark:text-gray-300">
                {contact.beachProximity}. Just steps away from the beautiful
                Unawatuna Beach
              </p>
            </div>
            ...
            <div class="p-6 text-center">
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Rated "Wonderful" 9.0/10 by our guests. Experience the
            ...
            <div class="p-6 text-center">
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Clean, comfortable rooms with traditional charm and modern
                amenities
              </p>
            </div>
          </div>
          ...
          <div class="mx-auto mt-12 max-w-3xl rounded-lg border-l-4 border-[#36CFC9] bg-gray-50 p-8 dark:bg-white/5">
            <p class="mb-4 text-lg text-gray-700 italic dark:text-gray-200">
              "Great place with very friendly hosts. Late check-in at 23:00 was
              no issue at all, which we really appreciated."
            </p>
...
export const head: DocumentHead = {
  title: "White Flower Guest - Unawatuna Beach Accommodation",
  meta: [
    {
      name: "description",
      content:
        "White Flower Guest offers comfortable accommodation very close to Unawatuna Beach, Sri Lanka. Book your stay and explore our rooms, airport transfers, tours, diving, and boat safari services.",
    },
    {
      name: "keywords",
      content:
    ...
    {
      property: "og:title",
      content: "White Flower Guest - Unawatuna Beach Accommodation",
    },
    {
