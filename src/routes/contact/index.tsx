...
export const head: DocumentHead = {
  title: "Contact Us - White Flower Guest",
  meta: [
    {
      name: "description",
      content:
        "Contact White Flower Guest in Unawatuna, Sri Lanka. Book your stay via WhatsApp or Booking.com. We're here to help with your accommodation needs.",
    },
  ],
};
